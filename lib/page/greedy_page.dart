...
class DessertRecommendationGreedy extends StatefulWidget {
  @override
  _DessertRecommendationState createState() => _DessertRecommendationState();
}

class _DessertRecommendationState extends State<DessertRecommendationGreedy> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Greedy Based On Rating")),
      body: Padding(
  ...
  VarianModel getVarianTerbaik(Dessert dessert, String rasa1, String rasa2) {
    ...
    return varian1.rating >= varian2.rating ? varian1 : varian2;
  }
}